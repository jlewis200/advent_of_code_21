...
class Probe:
    def __init__(self, v_x, v_y, x_scaler, y_scaler, step_size, rectangle, tgt_x_1, tgt_x_2, tgt_y_1, tgt_y_2):
        self.x = 0
        self.y = 0
        self.v_x = v_x
        self.v_y = v_y
        ...
        self.tgt_x_1 = tgt_x_1
        self.tgt_x_2 = tgt_x_2
        self.tgt_y_1 = tgt_y_1 + -0.4
        self.tgt_y_2 = tgt_y_2
    ...
    def step(self):
        ...
        if  self.x >= self.tgt_x_1 and \
            self.x <= self.tgt_x_2 and \
            self.y >= self.tgt_y_1 and \
            self.y <= self.tgt_y_2:

            self.rectangle.color = (0, 255, 0)
        else:
            self.rectangle.color = (255,0, 0)
...
tgt_y_1 = -1.0
tgt_y_2 = -y_2 / y_1
tgt_x_1, tgt_y_1 = transformer.transform(tgt_x_1, tgt_y_1)
tgt_x_2, tgt_y_2 = transformer.transform(tgt_x_2, tgt_y_2)
target = shapes.BorderedRectangle(tgt_x_1, tgt_y_2, (tgt_x_2 - tgt_x_1) * 1.13, (tgt_y_1 - tgt_y_2) * 2.4, border=5, color=(0, 0, 0), border_color=(0, 255, 0), batch=batch)
tgt_x_1 = x_1 / x_2
tgt_x_2 = 1.0
tgt_y_1 = -1.0
tgt_y_2 = -y_2 / y_1
...
def update(dt):
    ...
    if len(probes) < 100:
        ...
        probe = Probe(*coord, x_2, abs(y_2), 60, rectangle, tgt_x_1, tgt_x_2, tgt_y_1, tgt_y_2)
        probes.append(probe)
    ...
    for probe in probes:
        ...
        if probe.x > transformer.total_width or probe.y < -4:
